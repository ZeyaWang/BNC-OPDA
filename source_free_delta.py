...
subdir = f'{args.balance}_{args.lr}_{args.lr_scale}_{args.iter_factor}_{args.lambdav}_{args.max_k}_{args.KK}_{args.covariance_prior}_{args.score}_{args.classifier}_{args.thresh}'
...
if args.alpha == 1.0:
    outcsv = 'expdt_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.csv'.format(args.target_type, source_domain_name, target_domain_name, args.balance, args.lr, args.lr_scale,
                                                                  args.thresh, 0.0, args.max_k, args.KK, args.covariance_prior, args.score, args.classifier, args.batch_size)
else:
    outcsv = 'expdt_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.csv'.format(args.target_type, source_domain_name, target_domain_name, args.balance, args.lr, args.lr_scale,
                                                                  args.thresh, args.alpha, args.max_k, args.KK, args.covariance_prior, args.score, args.classifier, args.batch_size)

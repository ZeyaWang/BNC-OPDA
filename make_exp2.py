                                    ...
                                    for cov in covs:
                                        for sc in scs:
                                            for cl in clf:
                                                ...
                                                cmd = ('python /home/zwa281/UDA/BNC-OPDA/source_free3.py --total_epoch 10 --batch_size 64 --target_type {} --dataset {} --source {} --target {} --balance {} --lr {} '
                                                ...
                                                if cl:
                                                    ...
                                                    cmd += '\n'
                                                outcsv = 'exp3_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_64.csv'.format(target_type, domain[ds][src], domain[ds][tar], balance, lr, lr_scale, interval, lambdav, max_k, KK, cov, sc, cl)

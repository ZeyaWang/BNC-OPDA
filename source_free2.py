...
def train(ClustNet, train_ds, memory, optSets, epoch_step, global_step, total_step, classifier=False):
    ...
    for t in range(args.interval):
        ...
        for i, (im, (idx, plabel)) in enumerate(iters):
            ...
            ########## extra##########
            alpha = (1 + 10 * global_step / (total_step*len(loader)*args.interval)) ** (-3.0)
...
log_dir = f'exp_tmp_{args.dataset}/{args.target_type}/{source_domain_name}_{target_domain_name}/{subdir}/{now}'
...
outcsv = 'exp_tmp_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.csv'.format(args.target_type, source_domain_name, target_domain_name, args.balance, args.lr, args.lr_scale,

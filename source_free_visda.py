...
log_dir = f'expvd_{args.dataset}/{args.target_type}/{source_domain_name}_{target_domain_name}/{subdir}/{now}'
...
if args.alpha == 1.0:
    outcsv = 'expvd{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.csv'.format(now, args.target_type, source_domain_name, target_domain_name, args.balance, args.lr, args.lr_scale,
